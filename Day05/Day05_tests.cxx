...
TEST(Y2024_Day5Example,Test2) {
    ...
    auto x = buildOrderingGuide(input);
    auto v = buildOrderedList(x);
    EXPECT_EQ(7,v.size());
}

TEST(Y2024_Day5Example,Test3) {
    vector<string> input{
        "47|53",
        "97|13",
        "97|61",
    ...
    EXPECT_TRUE(verifyOrder(v, line));
    line = "97,61,53,29,13";
    EXPECT_TRUE(verifyOrder(v, line));
    line = "75,29,13";
    EXPECT_TRUE(verifyOrder(v, line));
    line = "75,97,47,61,53";
    EXPECT_FALSE(verifyOrder(v, line));
    line = "61,13,29";
    EXPECT_FALSE(verifyOrder(v, line));
    
}

TEST(Y2024_Day5Example,Test3b) {
    vector<string> input{
        "47|53",
        "97|13",
        "97|61",
